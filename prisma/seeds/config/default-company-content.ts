...
export const DEFAULT_SEED_COMPANY_CONTENT: Record<SeedContentLocale, SeedCompanyContent> = {
  en: {
    publicDescription:
      "A therapist-led practice using MyAlphaPulse for bookings, scheduling, and client operations.",
    publicSummary:
  ...
  es: {
    publicDescription:
      "Una práctica liderada por terapeutas que utiliza MyAlphaPulse para reservas, agenda y operaciones con pacientes.",
    publicSummary:
