...
export async function MedicalFooter() {
  ...
  return (
    <footer className="mt-16 border-t border-primary/12 bg-[radial-gradient(circle_at_top_left,oklch(var(--primary)/0.16),transparent_36%),radial-gradient(circle_at_top_right,oklch(var(--accent)/0.18),transparent_34%),linear-gradient(180deg,oklch(var(--background))_0%,oklch(var(--accent)/0.12)_100%)]">
      <div className="mx-auto max-w-7xl px-4 py-14 sm:px-6 lg:px-8 lg:py-16">
        <div className="surface-panel rounded-[32px] px-6 py-8 sm:px-8 sm:py-10">
